...
ครั้งต่อไปเปิด `DWB MCP Studio.exe` แล้วกด Start ได้เลย หากเลือกจำ key จะเก็บแบบเข้ารหัสด้วยบัญชี Windows นี้ ปิดหน้าต่างได้โดย tunnel ยังทำงานอยู่ เปิดกลับมาเพื่อ Stop หลังรีสตาร์ต Windows ต้องกด Start ใหม่
