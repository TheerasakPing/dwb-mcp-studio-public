...
The release does not contain Node.js, Desktop Commander, Desktop Commander Remote, OpenAI tunnel, other tunnel clients, third-party binaries, node_modules, personal modules, accounts, API keys or runtime data. It is not an official release of those projects and does not grant access to their services.
